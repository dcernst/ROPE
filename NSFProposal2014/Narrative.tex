...
addressed in greater detail in below, in section 2.4.
...
resources.  One immediate application of the collections in ROPE is the
...
We also expect that users will be able to contribute additional
...
Problems for Education, there is existing software that will provide a
basis for ROPE, and which will inform its development.  Three applications
...
reached a tipping point that argues strongly for the development of a
...
it is possible for uniformly recognized content and programs to be
developed collaboratively and openly.  And mathematics instructors are
increasingly connected by social networks and intentional communities, one
of which is the Inquiry Based Learning (IBL) community.  As more
...
as WeBWorK and project such as Wikipedia demonstrate that free, open
...
communities such as Project NExT [2] have developed in to networks of
...
and fall of 2015, to be tested in spring 2016.  In the summer of 2016 we
...
another is a component of the system that and full implementation of an
...
\bibitem{edfinity} ``Edfinity.''  accessed 1/23/14.
    \texttt{<http://edfinity.com/>}.

\bibitem{latex2rtf} ``LaTeX to RTF Converter.''  accessed 1/23/14.
