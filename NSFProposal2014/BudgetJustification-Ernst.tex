...
\begin{itemize}
\item \$5,320 for travel to the Joint Mathematics Meetings to meet with PIs.
\begin{itemize}
\item \$240 Registration Fee for PI
...
\item \$660 for food (\$44 per diem rate for 5 days each for PI and two students)
\end{itemize}
...
\item \$600 for lodging (\$200 per night for 3 nights)
\item \$176 for food (\$44 per diem rate for 5 days each for PI and two students)
\end{itemize}
\end{itemize} 
\end{enumerate}
